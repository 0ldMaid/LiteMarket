...
public class view_ip_log extends JFrame{//************************************************************************
...
JLabel header1_space = new JLabel("IP Address", JLabel.LEFT);
JLabel header2_space = new JLabel("Timestamp", JLabel.LEFT);
JLabel header3_space = new JLabel("Request", JLabel.LEFT);
JLabel header4_space = new JLabel("Status", JLabel.LEFT);




JLabel[][] ip_log_book = new JLabel[4][500];
...
//load images from JAR
	...
	jpk1.setPreferredSize(new Dimension(490, 10000));
	...
	for(int xloop2 = 0; xloop2 < 500; xloop2++){//*******************************************

	ip_log_book[0][xloop2] = new JLabel(lm.ip_log[0][xloop2], JLabel.LEFT);
	ip_log_book[1][xloop2] = new JLabel(lm.ip_log[1][xloop2], JLabel.LEFT);
	ip_log_book[2][xloop2] = new JLabel(lm.ip_log[2][xloop2], JLabel.LEFT);
	ip_log_book[3][xloop2] = new JLabel(lm.ip_log[3][xloop2], JLabel.LEFT);
	...
	ip_log_book[0][xloop2].setText(lm.ip_log[0][xloop2]);
	ip_log_book[1][xloop2].setText(lm.ip_log[1][xloop2]);
	ip_log_book[2][xloop2].setText(lm.ip_log[2][xloop2]);
	ip_log_book[3][xloop2].setText(lm.ip_log[3][xloop2]);
	...
	view_ip_log xr = new view_ip_log();
