...
public class blockchain_api_confirm{
...
get_wallet_balance();
	...
	String url1 = new String("https://blockchain.info/merchant/" + rpcuser + "/address_balance?password=" + rpcpassword + "&address=" + rpcaddress + "&confirmations=6");
